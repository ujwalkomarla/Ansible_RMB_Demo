...
author: [u'Ujwal Komarla (@ujwalkomarla)']
options:
  gather_subset:
    description:
...
# Collect only the auto_save_cfg facts
- exos_facts:
    gather_subset:
      - !all
      - !min
...
# Do not collect auto_save_cfg facts
- exos_facts:
    gather_network_resources:
      - "!auto_save_cfg"

# Collect auto_save_cfg and minimal default facts
- exos_facts:
    gather_subset: min
    gather_network_resources: auto_save_cfg
"""
